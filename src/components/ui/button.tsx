  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        warm: "gradient-warm text-primary-foreground shadow-soft hover:shadow-elevated hover:scale-[1.02]",
        cool: "gradient-cool text-secondary-foreground shadow-soft hover:shadow-elevated",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-soft",
        muted: "bg-muted text-muted-foreground hover:bg-muted/80",
        fab: "gradient-warm text-primary-foreground rounded-full shadow-elevated hover:shadow-glow hover:scale-105",
      },
      size: {
